@section('mainmenu')
		...
		<ul id="ulmenu">
			...
			<div style="float:right;height: 32px;position: absolute;right: 1px;top: 5px;">
				<span><img src="{{ asset('image/').'/'.'552489.png' }}" style="width: 25px;height: 20px;padding-right: 5px;"></span><b>Hotline:<span style="font-weight: bold;color:#00cc66;">(04)3.8528700</span></b>
			</div>
			</div>
		</div>
@endsection()
...
--
-- Host: localhost:3306
-- Generation Time: Aug 07, 2024 at 02:21 PM
...
CREATE TABLE `chitietdonhang` (
  ...
  `id_dondathang` smallint UNSIGNED NOT NULL,
...
CREATE TABLE `danhmucs` (
  ...
  `thutu` int UNSIGNED NOT NULL,
  `madanhmucha` int UNSIGNED NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `dondathang` (
  ...
  `id_khachhang` smallint UNSIGNED NOT NULL,
  `tongtien` double(8,2) NOT NULL,
  `phuongthucthanhtoan` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `khachhang` (
  ...
  `mat_khau` varchar(60) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
(1, 'Sach_954962', 'BỘ SÁCH HẠT GIỐNG CHO TÂM HỒN', 'Hùng', 39, '1', '978604775892_1_1__60664_thum_135.jpg', 2, 1),
(2, 'Sach_555705', 'ĐỜI THAY ĐỔI KHI CHÚNG TA THAY ĐỔI', 'Hùng', 95, '1', '21-chien-luoc-marketing-hang-dau__74151_thum_135.jpg', 8, 1),
(3, 'Sach_310117', '7 THÓI QUEN ĐỂ THÀNH ĐẠT', 'Khang', 41, '1', '5rcxwb7n__53979_thum_135.jpg', 1, 1),
(4, 'Sach_828322', 'CHÂM NGÔN ĐẠO ĐỨC CỦA PUBLIUS SYRUS', 'Phượng', 55, '1', '2414201971454_55575953_1255588541260243_6317788388657201152_n_591x960__17411_thum_135.jpg', 1, 1),
(5, 'Sach_246687', 'CUỘC SỐNG KHÔNG GIỚI HẠN', 'Phượng', 37, '1', '973976466.jpg', 2, 1),
(6, 'Sach_307195', 'CÁCH NGHĨ ĐỂ THÀNH CÔNG', 'Giang', 79, '1', 'bia___thay_tai_3_final-1_1_an_thum_135.jpg', 4, 1),
(7, 'Sach_842132', 'LÀM CHỦ TƯ DUY THAY ĐỔI VẬN MỆNH', 'Hà Nguyễn', 38, '1', '65313_05_03_19_death-note-tap-5__78069_thum.jpg', 2, 1),
(8, 'Sach_175402', 'NGƯỜI GIÀU CÓ NHẤT THÀNH BABYLON', 'Tuấn', 40, '1', '12012018120101_bia_hoang_de_meo_tap_3___01__1__968x1000_an_thum_135.jpg', 1, 1),
(9, 'Sach_115136', 'NHÀ GIẢ KIM', 'Hiếu', 33, '1', 'one-piece-magazine-tap-2__59590.jpg', 6, 1),
(10, 'Sach_846978', 'QUẲNG GÁNH LO ĐI MÀ VUI SỐNG', 'Hùng', 97, '1', 'anhtoi3_dacbiet_biaao_thumb__52183_thum_135.jpg', 8, 1),
...
CREATE TABLE `ratting` (
  `id` smallint UNSIGNED NOT NULL,
  `masach` int UNSIGNED NOT NULL,
  `makhachhang` smallint UNSIGNED NOT NULL,
  `xeploai` int UNSIGNED NOT NULL,
...
CREATE TABLE `rohang` (
  ...
  `anhbia` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `sachs` (
  ...
  `maloai` tinyint UNSIGNED NOT NULL,
  `manhaxuatban` tinyint UNSIGNED NOT NULL,
  `matacgia` tinyint UNSIGNED NOT NULL,
  ...
  `khuyenmai` tinyint UNSIGNED DEFAULT NULL,
  `anhbia` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `tap` smallint UNSIGNED NOT NULL,
  `sotap` smallint UNSIGNED NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `taikhoan` (
  `id` smallint UNSIGNED NOT NULL,
  `maquyen` tinyint UNSIGNED NOT NULL,
  `manhanvien` smallint UNSIGNED NOT NULL,
...
CREATE TABLE `tintuc` (
  `id` int UNSIGNED NOT NULL,
  `tentintuc` varchar(120) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `mota` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `thutu` int UNSIGNED NOT NULL,
  `matintuccha` int UNSIGNED NOT NULL,
  `ngaydang` date NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(1, 'dat12345', 'dsa@gmail.com', NULL, '$2y$10$XYq.QK611ktyONCk1PKqW.Lkf1fi0QcC2usObqjPMWFL6RFMmSWwa', NULL, 0, '2024-08-03 04:11:22', '2024-08-03 04:11:22'),
(4, 'dat123456', 'ds2a@gmail.com', NULL, '$2y$10$gkgQDDvwQSJ0yG0BWjPrw.BFZ0PQkMFfd58hN4u0PJqL/HhISjgB6', NULL, 1, '2024-08-03 04:49:59', '2024-08-03 04:49:59'),
(6, 'dat12345', 's@gmail.com', NULL, '$2y$10$SGls0iB6Ik6km.kSZ28gh.YlAAW7tZqcdk0ETIC2OHGoX5eS4E1Pm', NULL, 1, '2024-08-07 05:39:03', '2024-08-07 05:39:03'),
(7, 'dat1234566', 'dsa3@gmail.com', NULL, '$2y$10$O0IjRFXPhD2zWOBWYo0UxefYYk6ruSP7//OlKk/00aow.5yHHz.qq', NULL, 1, '2024-08-07 06:13:35', '2024-08-07 06:13:35'),
(10, 'dat123454444', 's33@gmail.com', NULL, '$2y$10$HBoXiPh6WUGu0.EXoMnxHOyKJxNvveM3udLIxd//obAdadDU8wsiq', NULL, 1, '2024-08-07 07:14:51', '2024-08-07 07:14:51');
...
CREATE TABLE `vanchuyen` (
  `id` tinyint UNSIGNED NOT NULL,
  `tenthanhpho` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
